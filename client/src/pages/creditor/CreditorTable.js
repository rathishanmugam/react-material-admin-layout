...
const CreditorTable = ({
    ...
    const deleteItem = row => {
        ...
        if (confirmDelete) {
             fetch((`http://localhost:8081/api/creditor/${row.address._id}/${row._id}`), {
                method: 'delete',
                headers: {
            ...
            <Table>
                <TableHead>
                    <TableRow>
                        ...
                        <StyledTableCell align="center" onClick={() => handleSort('gstIM')}>gstIM
                            <span>{col.colToSort === 'gstIM' ?
                                (col.reverse ? <ArrowUpwardIcon/> : <ArrowDownwardIcon/>) : null}</span>
                        </StyledTableCell>
                ...
                <TableBody>
                    {
                        ...
                        items.map(row => (
                            ...
                            <StyledTableRow key={row._id}>
                                ...
                                <StyledTableCell align="center">{row.gstIM}</StyledTableCell>
                                ...
                                <StyledTableCell align="center">
                                    ...
                                    <CreditorModel buttonLabel="Edit" item={row} updateState={updateState}/>{' '}
