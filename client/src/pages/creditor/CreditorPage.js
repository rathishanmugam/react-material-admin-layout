...
import AccountModel from './CreditorModel'
import AccountTable from './CreditorTable'
...
class CreditorPage extends Component {
    constructor() {
        super();
    ...
    getItems(page, limit, sort, order, filter) {
        ...
        let url = 'http://localhost:8081/api/creditor?' + query
    ...
    addItemToState = (item) => {
        ...
        this.setState({snackbaropen: true, snackbarmsg: ' creditor Added Into  Data Base Sucessfully'});
        this.getItems()
    }
