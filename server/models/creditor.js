...
let creditorSchema = new Schema({
    name: {type: String, required: true, validate: requiredStringValidator},
    gstIM: {type: String, unique: true, required: true},
    address: {
    ...
    phone2: {type: String, required: true, validate: [validatePhone, 'Please fill a valid phone no ']},
    mobile1: {type: String, required: true, validate: [validatePhone, 'Please fill a valid mobile no ']},
    mobile2: {type: String, required: true, validate: [validatePhone, 'Please fill a valid mobile no ']},
